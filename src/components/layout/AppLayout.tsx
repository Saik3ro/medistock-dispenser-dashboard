  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="px-3 pb-2 pt-1 transition-all duration-300">
          {isCollapsed ? (
            <div className="flex flex-col items-center justify-center gap-1.5 rounded-md border border-sidebar-border bg-sidebar-accent/40 py-3 text-sidebar-foreground">
              ...
              <div title={`${device.ssid} · ${device.signal}%`}>
                <Wifi className="h-3.5 w-3.5 text-sidebar-foreground/60" />
              </div>
            </div>
          ) : (
            ...
            <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground" title={`${device.ssid} · ${device.signal}%`}>
      ...
      <main className={`transition-all duration-300 ${
        ...
        <div className="mx-auto w-full max-w-350 px-4 pb-24 pt-6 sm:px-6 lg:pb-10">
          <Outlet />
        </div>
      </main>
